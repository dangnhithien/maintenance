...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "loai-linh-kien", label: "Loại thành phần", path: "/part-types" },
      { id: "nhom-linh-kien", label: "Nhóm thành phần", path: "/part-groups" },
      { id: "sku-linh-kien", label: "SKU thành phần", path: "/part-SKUs" },
      { id: "linh-kien", label: "Thành phần", path: "/part-details" },
    ],
  },
  {
    id: "nhan-vien",
              ...
              >
                ...
                <ListItemText
                  ...
                  primaryTypographyProps={{
                    sx: {
                      fontSize: "14px",
                      fontWeight: "bold", // áp dụng in đậm nếu đang active
                      whiteSpace: "nowrap",
                      overflow: "hidden",
                      textOverflow: "ellipsis",
                    },
