...
import usePartType from '@modules/maintenance/hooks/usePartType'
...
const PartTypeList: React.FC = () => {
	const [openPopupHardDelete, setOpenPopupHardDelete] = useState(false)
	const { notify } = useNotification()

	const [params, setParams] = useState<IPartTypeGet>({
		takeCount: 10,
		sortBy: 'CreatedDate DESC',
	})

	const { partTypes, fetchPartTypes, deletePartType } = usePartType()
