...
import useDeviceModel from '@modules/maintenance/hooks/useDeviceModel'
...
const DeviceModel: React.FC = () => {
	...
	const [params, setParams] = useState<IDeviceModelGet>({
		includeProperties: 'DeviceType,DeviceGroup,DeviceSKU',
		takeCount: 10,
		sortBy: 'CreatedDate DESC',
	})

	const { deviceModels, fetchDeviceModels, deleteDeviceModel } =
		useDeviceModel()

	const initData = () => {
		fetchDeviceModels(params)
	}
