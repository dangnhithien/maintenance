...
import useDeviceGroup from '@modules/maintenance/hooks/useDeviceGroup'
...
const DeviceGroup: React.FC = () => {
	...
	const [params, setParams] = useState<IDeviceGroupGet>({
		includeProperties: 'DeviceType',
		takeCount: 10,
		sortBy: 'CreatedDate DESC',
	})

	const { deviceGroups, fetchDeviceGroups, deleteDeviceGroup } =
		useDeviceGroup()

	const initData = () => {
		fetchDeviceGroups(params)
	}
